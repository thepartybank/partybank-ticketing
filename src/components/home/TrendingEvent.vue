    ...
    <div class="relative w-full overflow-hidden py-10">
      ...
      <div
        ...
        :class="{
          ...
          '-translate-x-[150%] md:-translate-x-[80%]': currentIndex === 2,
        }"
        ref="slider"
      >
        <!-- Slider Cards -->
      ...
      <button class="text-black px-4 py-2 rounded absolute bottom-1 left-[12%]" @click="prevSlide">
        PREV <img src="" alt="" />
      </button>
      <button class="text-black px-4 py-2 rounded absolute bottom-1 right-[15%]" @click="nextSlide">
        NEXT
      </button>
    </div>
  </section>
